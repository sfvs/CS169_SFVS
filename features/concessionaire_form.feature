Feature: view, fill, and submit the concessionaire form
 
  As an avid user
  So that I can complete the application
  I want to be view the concessionaire form and
...
Scenario: view current application status
  When I follow concessionaire_form
  Then I should be on the "concessionaire_form" page
  ...
  And I should see completed for "concessionaire_form"